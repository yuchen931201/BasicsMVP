...
data class MainPageBean (
    ...
    data class IndexItem( @SerializedName("iname")var iname: String,
           @SerializedName("ivalue") var ivalue: String, @SerializedName("detail") var detail: String) : Serializable

    data class APIItem(@SerializedName("so2")var so2: String
        ...
        data class AqiInfo(@SerializedName("level")var level: String,
                           @SerializedName("color")var color: String,
                           @SerializedName("affect")var affect: String,
                           @SerializedName("measure")var measure: String ): Serializable
    }
